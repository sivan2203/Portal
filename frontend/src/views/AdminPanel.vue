                ...
                <b-row>
                    <b-col md="1">
                        <b-form-group label="News id">
                            <b-form-input v-model="newsData.newsId" />
                        </b-form-group>
                    </b-col>

                    <b-col md="6">
                        <b-form-group label="News Title" class="mb-2">
                            <b-form-input v-model="newsData.newsTitle" />
                        </b-form-group>
                    </b-col>
                    <b-col md="12">
                        <b-form-group label="News Text">
                            <b-form-textarea v-model="newsData.newsText" />
                        </b-form-group>
                    </b-col>
...
export default {
    ...
    methods: {
        ...
        submitFile() {
            ...
            axios
                .post("api/news/new", formData, {
                    headers: {
                        "Content-Type": "multipart/form-data"
                    }
                })
                .then(() => {
                    axios.post("api/news/new", this.newsData, {
        ...
        findNewsById() {
            axios
                .post(`api/news/${this.newsData.newsId}`)
                .then(response => {
                    this.file = response.data;
                    this.newsData.newsTitle = response.data.title;
                    this.newsData.newsText = response.data.content;
                })
                .catch(error => {
                    console.log(error);
                });
        ...
        deleteNewsById() {
            axios
                .delete(`api/news/delete/${this.newsData.newsId}`)
                .then(response => {
        ...
        updateNews() {
            axios
                .put(`api/news/edit/${this.newsData.newsId}`, this.newsData)
                .then(response => {
                    console.log(response.status);
                })
                .catch(error => {
